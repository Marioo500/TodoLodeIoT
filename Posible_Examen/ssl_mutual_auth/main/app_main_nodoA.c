...
void leer_sensor()
{
    ...
    snprintf(buffer, 100, "%s,%f", status == 1 ? "ON" : "OFF", voltage);
    esp_mqtt_client_publish(client, "hospital/piso1/recepcion/adc_soil", buffer, 0,0,0);
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_DATA:
        ...
        if (!strcmp(event->data, "Hola"))
        {
            ESP_LOGI(TAG, "Llega a esto porque le mande un Hola");
        }
